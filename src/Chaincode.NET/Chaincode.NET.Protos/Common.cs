...
namespace Chaincode.NET.Protos {
  ...
  public sealed partial class Payload : pb::IMessage<Payload> {
    ...
    public void MergeFrom(Payload other) {
      ...
      if (other.header_ != null) {
        if (header_ == null) {
          header_ = new global::Chaincode.NET.Protos.Header();
        }
  ...
  public sealed partial class Block : pb::IMessage<Block> {
    ...
    public void MergeFrom(Block other) {
      ...
      if (other.header_ != null) {
        if (header_ == null) {
          header_ = new global::Chaincode.NET.Protos.BlockHeader();
        }
        Header.MergeFrom(other.Header);
      }
      if (other.data_ != null) {
        if (data_ == null) {
          data_ = new global::Chaincode.NET.Protos.BlockData();
        }
        Data.MergeFrom(other.Data);
      }
      if (other.metadata_ != null) {
        if (metadata_ == null) {
          metadata_ = new global::Chaincode.NET.Protos.BlockMetadata();
        }
