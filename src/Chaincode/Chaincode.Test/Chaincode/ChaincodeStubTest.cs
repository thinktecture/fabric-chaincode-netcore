...
namespace Thinktecture.HyperledgerFabric.Chaincode.Test.Chaincode
{
    public class ChaincodeStubTest
    {
        ...
        {
            return CreateChaincodeStub(handler, "ChannelId", "TxId", new ChaincodeInput(), CreateValidSignedProposal());
        }

        private ChaincodeStub CreateValidChaincodeStub()
        {
            return CreateValidChaincodeStubWithHandler(null);
        }
