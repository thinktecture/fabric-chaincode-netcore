    ...
    static ChaincodeShimReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::Chaincode.NET.Protos.GetStateByRange), global::Chaincode.NET.Protos.GetStateByRange.Parser, new[]{ "StartKey", "EndKey", "Collection" }, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::Chaincode.NET.Protos.GetQueryResult), global::Chaincode.NET.Protos.GetQueryResult.Parser, new[]{ "Query", "Collection" }, null, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::Chaincode.NET.Protos.QueryResponse), global::Chaincode.NET.Protos.QueryResponse.Parser, new[]{ "Results", "HasMore", "Id" }, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class ChaincodeMessage : pb::IMessage<ChaincodeMessage> {
    ...
    public void MergeFrom(ChaincodeMessage other) {
      ...
      if (other.proposal_ != null) {
        if (proposal_ == null) {
          proposal_ = new global::Chaincode.NET.Protos.SignedProposal();
        }
        Proposal.MergeFrom(other.Proposal);
      }
      if (other.chaincodeEvent_ != null) {
        if (chaincodeEvent_ == null) {
          chaincodeEvent_ = new global::Chaincode.NET.Protos.ChaincodeEvent();
        }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 8: {
            type_ = (global::Chaincode.NET.Protos.ChaincodeMessage.Types.Type) input.ReadEnum();
            break;
          }
          case 18: {
            if (timestamp_ == null) {
