...
namespace Chaincode.NET.Handler
{
    public interface IHandler
    {
        ...
        Task<ByteString> HandleGetState(string key, string channelId, string txId);
        Task<ByteString> HandlePutState(string key, ByteString value, string channelId, string txId);
        Task<ByteString> HandleDeleteState(string key, string channelId, string txId);
        Task HandleGetStateByRange(string startKey, string endKey, string channelId, string txId);
        ...
        Task HandleGetQueryResult(string query, string channelId, string txId);
